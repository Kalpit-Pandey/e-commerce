...
function createSliderItem(imgUrl: string, Name: string, Price: string) {
...
function createFeature(imgUrl: string, title: string, desc: string) {
...
//Defining Product and Color types
interface Color {
  code: string;
  img: string;
}
